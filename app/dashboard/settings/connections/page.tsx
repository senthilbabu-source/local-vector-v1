...
// ---------------------------------------------------------------------------
// ConnectionsPage — Server Component (Sprint 130)
//
// Platform connection management hub for Apple BC.
...
// NOTE: Bing Places write API retired — Bing is manual_url only (see platform-config.ts)
// ---------------------------------------------------------------------------
      ...
      <div className="max-w-2xl space-y-5" data-testid="connections-page">
        <div>
          ...
          <p className="mt-0.5 text-sm text-slate-400">
            Sync your business data to Apple Maps and more.
          </p>
        </div>
