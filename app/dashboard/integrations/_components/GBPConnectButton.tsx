      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-3">
          <a
            ...
            className={`inline-flex items-center gap-2 rounded-lg bg-blue-500/10 px-4 py-2 text-sm font-semibold text-blue-400 ring-1 ring-inset ring-blue-400/20 transition hover:bg-blue-500/20 ${isRedirecting ? 'pointer-events-none opacity-50' : ''}`}
          >
            {isRedirecting ? (
            ...
            {isRedirecting ? 'Redirecting to Google…' : 'Connect Google Business Profile'}
          </a>
        </div>
