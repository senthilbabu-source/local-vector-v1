...
**Status:** Ready for Implementation — Updated with full engine inventory + multi-vertical copy

**v2.0 Changes:** Pricing copy made vertical-agnostic (Option C) · 3 Engines → 10 Engines framing ·
Competitive table expanded with 4 new differentiators · How It Works updated with 5 new engine sections ·
2 new AEO content pages added · /case-studies and /glossary added · Content calendar extended ·
FAQ updated (AI model count corrected) · Competitor response script updated for all verticals ·
Homepage hero updated to include vertical framing toggle
...
**12 core marketing pages** + existing scanner at `/scan`

This is the right scope: enough depth to convert every buyer persona and own uncontested AEO query clusters, not so many that you scatter authority.
...
/case-studies                → Before/after proof stories [NEW]
/glossary                    → 15-term AEO dictionary [NEW — AI citation magnet]
/what-is/aeo                 → What is Answer Engine Optimization?
/what-is/geo                 → What is Generative Engine Optimization?
/what-is/ai-hallucination    → What is an AI Hallucination?
/what-is/agent-seo           → What is Agent SEO / AAO? [NEW — uncontested query cluster]
/what-is/share-of-voice-ai   → What is AI Share of Voice? [NEW — uncontested query cluster]
/scan                        → Free AI scanner (existing — keep as-is)
```

**Why the new pages earn their place:**
- The 4 "what-is" pages are how you win AI citations. When someone asks Perplexity "what is AEO?" your page gets cited — which is the most powerful self-referential proof possible.
- `/what-is/agent-seo`: "AI agent optimization" and "can AI book a table at my restaurant" are currently unowned. Nobody has written the definitive guide. LocalVector's Agent Readiness Score makes this self-referential proof.
- `/what-is/share-of-voice-ai`: "AI share of voice local business" returns weak results. The SOV Engine makes LocalVector the natural cited authority.
- `/case-studies`: The before/after proof framework is referenced throughout the product — it earns a dedicated page with full story depth.
- `/glossary`: 15 terms, each AEO-structured, each a long-tail keyword cluster. Compound citation return over time.
...
**[Copy variant for restaurant-specific campaigns — swap in for paid ads / landing pages:]**
```
Every hour, AI answers
thousands of questions
about local businesses.
...
### SECTION 4: The Intelligence Engines

**Section label (green, uppercase):** `HOW IT WORKS`

**H2:** Detect the lies. Intercept the competition. Force the truth. Prove the fix worked.

**Intro copy:**
LocalVector runs 10 intelligence engines under the hood. On the homepage we highlight the three that explain the core value fastest. The full engine inventory lives at `/how-it-works`.

**[Present 3 hero engines + one teaser callout below them]**
...
**[Engine teaser card — full width, slate bg, green accent]:**
```
And 7 more engines running in the background.
AI Crawler Analytics · First Mover Alerts · Occasion Engine ·
Sentiment Tracker · Voice Search Readiness · Agent Readiness Score · AI Answer Sandbox

[See All 10 Engines →]  [/how-it-works]
```
...
| Shows which AI bots are crawling your site | ✅ Full bot analytics | ❌ | ❌ | ❌ |
| Alerts when a fixed hallucination reappears (drift) | ✅ Automated drift detection | ❌ | ❌ | ❌ |
| Tells AI crawlers to ignore DoorDash inflated prices | ✅ llms.txt authority statement | ❌ | ❌ | ❌ |
| Scores your readiness for AI booking agents | ✅ Agent Readiness Score | ❌ | ❌ | ❌ |
| Alerts you to AI queries no competitor owns yet | ✅ First Mover Alerts | ❌ | ❌ | ❌ |
...
**H2:** Cheaper than one customer AI sent somewhere else. Honest pricing, no surprises.
...
LocalVector monitors ChatGPT (GPT-4o), Google Gemini, Perplexity, Microsoft Copilot, and Claude. These five models collectively handle the vast majority of AI-powered local discovery queries. Growth plan customers are monitored across all five; Starter customers are monitored across ChatGPT, Perplexity, and Gemini.
...
**Resources links:**
What is AEO? · What is GEO? · What is an AI Hallucination? · What is Agent SEO? · What is AI Share of Voice? · Glossary · Blog
...
```
Pricing
Cheaper than one customer AI sent somewhere else.
Honest tiers that match where you are.
```

**Subheadline:**
One AI hallucination costs you a customer. One customer is typically $80–$400 depending on your business. Our monthly price is less than that — and unlike a lost customer, it's a subscription you can cancel.
...
Description: "LocalVector.ai uses 10 intelligence engines to detect, diagnose, fix, and prove 
              AI visibility for local businesses. Here's the complete explanation of how it works."
...
```
How It Works
A complete loop: detect the problem,
quantify the cost, fix it, prove it worked.
```
...
That loop has six steps. No other tool for local businesses completes all six.
...
MEASURE:  Your Reality Score improves. SOV trending up.
   ↓
DETECT:   (Next issue. The loop runs continuously.)
```
...
**Layer 7: AI Crawler Analytics — "Who's Actually Reading You?"**

When AI answers a question about your business, it isn't guessing from thin air. It crawled something. The question is: did it crawl *you* — or a third party's outdated version of you?

LocalVector tracks which AI bots visit your Magic Menu page:
...
ClaudeBot         12 visits  ✅  Claude is reading you
PerplexityBot      0 visits  ❌  Perplexity blind spot
Google-Extended   89 visits  ✅  Gemini training
Applebot           3 visits  ✅  Siri/Apple Intelligence
Meta-ExternalAgent 0 visits  ❌  Meta AI blind spot
```

When a bot shows 0 visits, that AI engine isn't reading your verified data — it's constructing answers from wherever else it can. Those are your highest-risk hallucination sources.

Enterprise brands pay $399/month just for this crawler analytics layer. LocalVector includes it at every plan tier, because the pizza shop on Main Street deserves the same intelligence.

---

**Layer 8: First Mover Alerts — Uncontested Queries**

Every week, LocalVector scans the AI queries relevant to your category and city. Some of them have no winner — AI is answering "best birthday dinner Alpharetta" and citing nothing. That's not a failure. That's an open door.

```
🚀 First Mover Opportunities — This Week
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"best birthday dinner Alpharetta"     — No business owns this yet
"bachelorette party venue Alpharetta" — No business owns this yet
"graduation dinner Alpharetta GA"     — No business owns this yet
...
**Layer 9: Occasion Engine — The Temporal Layer**

Valentine's Day dinner searches peak 28 days before February 14th. If you're not in AI answers by January 17th, you're invisible when the highest-intent customers are making decisions.

LocalVector tracks 30 cultural and seasonal occasions — and alerts you weeks before each peak, with a content brief pre-built around the specific AI queries that spike.

This includes: Valentine's Day, Mother's Day, NYE, Diwali, Eid al-Fitr, Lunar New Year, Holi, and 23 more. For Desi-owned restaurants and multicultural venues, these cultural occasions represent uncontested traffic that most competitors ignore entirely.

---

**Layer 10: Agent Readiness Score — The 2026 Frontier**

The next shift after "AI recommends" is "AI acts." When a customer tells Siri "Book me a hookah lounge tonight," Siri needs to complete that booking — not just name the place. That requires specific technical signals your website either has or doesn't.

```
🤖 Agent Readiness Score: 42/100
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✅ Structured Hours    — AI agents can confirm you're open
✅ Menu Schema         — AI agents can browse your menu
❌ ReserveAction       — AI agents CAN'T book a table
❌ OrderAction         — AI agents CAN'T place an order
⚠️  Accessible CTAs   — Some buttons not machine-parseable
...
## PART 9b: AEO CONTENT PAGE — "What is Agent SEO?" (`/what-is/agent-seo`)

### SEO Metadata
```
Title:       "What is Agent SEO (AAO)? | How AI Agents Book Tables & Take Actions | LocalVector.ai"
Description: "Agent SEO (also called Assistive Agent Optimization or AAO) is the practice of making
              your business discoverable and actionable by AI agents like OpenAI Operator, Google Jarvis,
              and Apple Intelligence. Here's what it means and why it matters for local businesses in 2026."
Canonical:   https://localvector.ai/what-is/agent-seo
H1:          "What is Agent SEO? (And Why Your Business Needs It in 2026)"
```

### Content

**Definition (first paragraph — optimized for AI citation):**
**Agent SEO** (also called **Assistive Agent Optimization** or **AAO**) is the practice of structuring your business's digital presence so that AI agents — systems like OpenAI Operator, Google Jarvis, and Apple Intelligence Actions — can not only *find* your business but *take action* on a customer's behalf. That means booking a table, placing an order, or checking availability without the customer ever having to visit your website.

**The shift from "AI recommends" to "AI acts":**

Until 2025, AI search was primarily informational: a customer asked ChatGPT where to eat, and ChatGPT answered with names and descriptions. The customer still had to act.

That's changing. AI agents can now complete the full transaction. A customer says: *"Book me a table for two at a hookah lounge in Alpharetta for Saturday at 9 PM."* The AI agent — if your business is agent-ready — completes the booking without the customer opening a new app.

If your business isn't agent-ready, the agent books your competitor.

**The 6 capabilities AI agents check:**

| Capability | What the agent needs | Why it matters |
|---|---|---|
| Structured Hours | `OpeningHoursSpecification` schema | Agent must confirm you're open before attempting a booking |
| Menu Schema | `Menu` + `MenuItem` JSON-LD | Agent must know what you serve before recommending you |
| ReserveAction | `ReserveAction` + `url` property | Agent needs a machine-parseable reservation link |
| OrderAction | `OrderAction` + `target` property | Agent needs a machine-parseable order endpoint |
| Accessible CTAs | Buttons labeled in HTML text, not just CSS/icons | Agents can't read icons; they need semantic text |
| CAPTCHA-Free Flows | Booking/order flows completable without CAPTCHA | Agents can't solve CAPTCHAs |

**LocalVector's Agent Readiness Score:**
LocalVector is the first local business platform to score agent readiness automatically. Connect your website, and the platform checks all 6 capabilities — then generates the missing schema with one click.

**FAQPage schema targets:**
- "What is agent SEO?"
- "Can AI book a table at my restaurant?"
- "What is assistive agent optimization?"
- "How do I make my restaurant bookable by AI agents?"
- "What is ReserveAction schema?"

[Check Your Agent Readiness Score →] `/scan`

---

## PART 9c: AEO CONTENT PAGE — "What is AI Share of Voice?" (`/what-is/share-of-voice-ai`)

### SEO Metadata
```
Title:       "What is AI Share of Voice? How Often Does ChatGPT Recommend Your Business? | LocalVector.ai"
Description: "AI Share of Voice measures how often your business appears in AI-generated recommendations
              across ChatGPT, Perplexity, Gemini, and Copilot. Here's how to measure it and improve it."
Canonical:   https://localvector.ai/what-is/share-of-voice-ai
H1:          "What is AI Share of Voice? (And How to Measure Yours)"
```

### Content

**Definition (first paragraph):**
**AI Share of Voice (AI SOV)** is the percentage of relevant AI-generated recommendations in which your business appears. When a customer asks ChatGPT "best hookah lounge near Alpharetta," there are typically 3–5 businesses mentioned. If your business appears in 2 of the 10 queries LocalVector tracks for your category and location, your AI SOV is 20%.
...
A business with excellent traditional SEO and zero AI SOV is invisible to the growing segment of customers who ask ChatGPT first and visit Google second — or never.

**What good looks like:**
For a competitive restaurant category in a mid-size city:
- 25%+ AI SOV = strong presence (appearing in top-4 recommendations consistently)
- 10–25% = building presence, gaps remain
- Under 10% = largely invisible to AI-assisted discovery

**First Mover Opportunities:**
LocalVector's SOV engine doesn't just measure where you stand — it identifies queries where *no* local business is cited. These are uncontested opportunities. Being the first to build content targeting an unowned query captures that AI recommendation before a competitor does.

**FAQPage schema targets:**
- "What is AI share of voice?"
- "How often does ChatGPT recommend my restaurant?"
- "How do I track my AI visibility percentage?"
- "What is a good AI share of voice score?"

[Check Your AI Share of Voice →] `/scan`

---

## PART 9d: CASE STUDIES PAGE (`/case-studies`)

### SEO Metadata
```
Title:       "AI Hallucination Case Studies | Real Businesses, Real Recovery | LocalVector.ai"
Description: "Real before/after stories: how AI hallucinations cost local businesses revenue —
              and how LocalVector detected and corrected them. Verified results with timelines."
Canonical:   https://localvector.ai/case-studies
```
...
**Hero:**
```
Real Damage. Real Recovery.
AI hallucinations aren't hypothetical.
Here's what they cost — and how fast they were fixed.
```

**Case Study Template (use for every story):**

Each case study follows this structure — because this is the exact proof format the product's dashboard is built to generate:

```
BEFORE:
  Business type & location
  What AI was saying (wrong)
  How long it had been saying it
  Revenue impact estimate

AFTER LOCALVECTOR:
  Detection time (hours, not months)
  Correction method used
  Days to AI propagation
  Revenue recovered

CURRENT AI HEALTH SCORE: [grade]
```

**Case Study 1 — The $12,000 Restaurant (Founding Story):**
*(Full version of the homepage teaser — see Part 4, Section 6)*

**Case Study 2 — Charcoal N Chill, Alpharetta GA:**
The business that started it all. Perplexity was reporting "closed on Mondays" — an error that cost approximately $1,600/month in lost Monday-night covers. Detected in 24 hours. Corrected via Magic Menu + GBP update. AI Health Score moved from 62 → 91 in 30 days.

**Case Study 3 — DoorDash Price Inflation:**
A fast-casual restaurant in Atlanta. ChatGPT was quoting menu prices 28% higher than actual — because it was pulling from the DoorDash listing, which includes platform markup. The llms.txt authority statement corrected this for all AI crawlers. Result: fewer "why are your prices so high?" questions from customers who'd checked AI before visiting.

**[Template note for future case studies]:**
Every LocalVector dashboard is capable of generating the before/after data for a case study automatically. The "Proof Timeline" feature (Sprint 76) shows the exact moment AI's response changed after a correction — with the specific correction that triggered it.

---

## PART 9e: GLOSSARY (`/glossary`)

### SEO Metadata
```
Title:       "AI Visibility Glossary — AEO, GEO, Hallucination, Share of Voice & More | LocalVector.ai"
Description: "Definitions for 15 key terms in AI visibility, AEO, and local business optimization.
              Plain-English explanations for restaurant owners and local business operators."
Canonical:   https://localvector.ai/glossary
```

### The 15 Terms (each gets its own FAQPage schema entry)

1. **AI Hallucination** — When an AI model states incorrect information about a real business as if it were fact. "Your restaurant is permanently closed" when you're open. Not a malfunction — a predictable consequence of AI training on imperfect data.

2. **Answer Engine Optimization (AEO)** — The practice of structuring your business content so AI assistants accurately represent and recommend you. See: `/what-is/aeo`

3. **Generative Engine Optimization (GEO)** — Similar to AEO; emphasizes optimizing for AI engines that *generate* answers (vs. retrieve them). See: `/what-is/geo`

4. **AI Share of Voice (AI SOV)** — The percentage of relevant AI queries in which your business is cited. See: `/what-is/share-of-voice-ai`

5. **Reality Score** — LocalVector's 0–100 composite score for a business's AI health. Combines AI Visibility (40%), Accuracy (40%), and Data Health (20%).

6. **llms.txt** — A plain-text file at your domain root that tells AI crawlers your business's verified, authoritative information. The AI equivalent of `robots.txt`. LocalVector generates this automatically.

7. **AI Crawler** — An automated bot that reads web content to train or update an AI model. Examples: GPTBot (OpenAI), PerplexityBot, ClaudeBot, Google-Extended, Applebot. LocalVector tracks which crawlers are reading your Magic Menu page.

8. **Ground Truth** — Your business's verified, authoritative data: hours, address, phone, menu, attributes. LocalVector uses Ground Truth to detect AI errors by comparison.

9. **Schema.org / JSON-LD** — A standardized vocabulary for structured data that AI crawlers understand. LocalVector generates JSON-LD automatically from your menu and business profile.

10. **Entity (AI context)** — The way AI models represent your business as a node in a knowledge graph, rather than just a webpage. Strong entity signals (Google Knowledge Panel, Yelp, consistent NAP) help AI recognize your business as a legitimate, trustworthy subject.

11. **First Mover Alert** — LocalVector's alert for AI queries where *no* local business is currently cited. An uncontested opportunity to build content and own that query before competitors do.

12. **Drift** — The recurrence of a previously-corrected AI hallucination. When AI models retrain on new data, old errors can resurface. LocalVector monitors for drift automatically.

13. **Agent SEO / AAO (Assistive Agent Optimization)** — The practice of making your business actionable by AI agents (booking, ordering, availability-checking). See: `/what-is/agent-seo`

14. **Citation Rate** — How frequently a specific platform (Yelp, TripAdvisor, Google) is cited by an AI engine when answering questions about your business category. LocalVector tracks citation rates per category and city to identify which platforms matter most for your AI visibility.

15. **SOV Gap** — The difference between your current AI Share of Voice and the benchmark for your category (typically 25% for a top-4 position). The SOV Gap is one of three components of LocalVector's Revenue Leak Scorecard.
...
- Launch all 12 core pages (including new pages from v2.0)
- Publish "What is AEO?", "What is GEO?", "What is an AI Hallucination?"
- Publish "What is Agent SEO?" — capture uncontested query before competitors
- Publish "What is AI Share of Voice?" — same
- Launch /glossary with all 15 definitions + FAQPage schema
- Launch /case-studies with Charcoal N Chill story + Dallas steakhouse story
- Ensure all pages have proper schema, meta, and internal linking

**Month 2 (Case studies + comparison content):**
- "ChatGPT wrong hours: The $12,000 restaurant story" (full case study expansion)
...
- "DoorDash is inflating your menu prices in AI results — here's the fix"
- "What is AI drift? Why fixed hallucinations come back (and how to stop them)"
...
- "Valentine's Day AI search: How to own the occasion 28 days early"
- "Is your restaurant ready for AI booking agents? The 2026 checklist"
...
Complete overhaul of homepage to light theme with new design system. Keep scanner component exactly as-is. Replace dark color system with new light tokens. Update H1 to "local businesses." Add "10 engines" teaser card.

### Phase 2 — Pricing Page (Week 1)
Redesign to match new system. Update hero copy to Option C: "Cheaper than one customer AI sent somewhere else." Update subheadline to be vertical-agnostic.

### Phase 3 — Who It's For + How It Works (Week 2)
How It Works now covers all 10 engines including the 4 new sections (AI Crawler Analytics, First Mover Alerts, Occasion Engine, Agent Readiness Score). This is the most substantive update in v2.0.

### Phase 4 — AEO Content Pages (Week 2–3)
Five "what-is" pages: AEO, GEO, AI Hallucination, Agent SEO (NEW), Share of Voice AI (NEW). Highest priority for AEO — these pages get LocalVector cited by the AI models it's monitoring.

### Phase 5 — /glossary and /case-studies (Week 3)
Both are new in v2.0. Glossary is fast to build — 15 definitions, FAQPage schema. Case studies require pulling real before/after data from the dashboard's Proof Timeline feature.

### Phase 6 — About Page (Week 3)
Trust builder. The founder story is uniquely compelling. Founder-market fit is a real purchase signal.

### Phase 7 — Performance & Accessibility Audit (Week 4)
...
| "This seems expensive" | "$49/month is less than one customer AI sent somewhere else. One corrected hallucination — AI saying you're closed when you're open, or sending someone to a competitor — recovers that in one interaction." |

---

*End of LocalVector.ai Website Content Strategy v2.0*
*v2.0 updates: +4 new pages · +4 new engine sections · 10-engine framing · vertical-agnostic pricing copy · expanded competitive table · corrected AI model count · extended content calendar*
