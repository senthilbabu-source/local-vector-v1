-- ============================================================
-- Migration: 20260223000002_content_pipeline.sql
...
-- Depends on: 20260223000001_sov_engine.sql (references sov_target_queries)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS public.content_drafts (
  ...
  trigger_id      UUID          NULL,   -- FK to competitor_intercepts, sov_target_queries, or local_occasions
...
-- Seed data for 30+ occasions goes in a separate seed file (occasions_seed.sql)
