...
|-------|--------|---------|------------------|
| Unit + Integration | Vitest | `npx vitest run` | **549 passing**, 0 skipped (after `supabase db reset`) |
