...
> and the `tests/e2e/` directory. Last updated: Post-Sprint 49 Inngest Job Queue (2026-02-25).
...
|-------|--------|---------|------------------|
| Unit + Integration | Vitest | `npx vitest run` | **749 passing**, 7 skipped (after `supabase db reset`) |
...
> **Last updated:** Post-Sprint 49 Inngest Job Queue (2026-02-25) — 47/47 E2E + 749 unit/integration passing. Sprint 49: +31 tests from 3 new suites (`inngest-sov-cron` +11, `inngest-audit-cron` +9, `inngest-content-audit-cron` +6) + 5 added to existing suites (`cron-sov` 21→23, `cron-audit` 12→15). Sprint 48: +77 from 4 new suites + 18 added. Sprint 47: +19 new. Sprint 46: +55 new. Sprint 45: +21. Sprint 44: +36. Sprint 43: +23. Sprint 42: +46 unit + 10 E2E. Sprint 36: +49 from Surgical Integration day.
